      ...
      <div className="flexBetween py-4">
        ...
        <div className="flexCenter mx-20 gap-x-4">
          ...
          <div className="mx-10">
            <Navbar
              containerStyles={
                "hidden xl:flex gap-x-5 xl:gap-x-10 medium-25 rounded-full px-2 py-1"
              }
            />
          </div>
          {/* mobile */}
          ...
          <div className="flexBetween gap-x-3 sm:gap-x-2 bold-16">
            ...
            <div className="flexBetween sm:gap-x-6">
              <NavLink to={"/"} className={"flex"}>
                ...
                <span className="relative flexCenter w-5 h-5 rounded-full bg-secondary text-primary font-medium-14 -top-2 right-3">
                  {0}
                </span>
              </NavLink>
              {/* <NavLink
                to={"/"}
                className={
                  "hidden sm:flex btn-secondary flexCenter gap-x-2 medium-16 rounded-xl"
                }
              >
